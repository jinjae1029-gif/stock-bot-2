...
// --- CONFIGURATION ---
const TARGET_URL = 'https://jinjae1029-gif.github.io/stock-bot-2/';
const TARGET_BOT_ID = 'stock-bot-2';
...
(async () => {
    console.log("🚀 Starting Scraper Bot (Bot 2)...");
    ...
    try {
        ...
        let cleanText = rawText
            .replace('주문표 (Order Sheet)', '📅 <b>주문표 (Bot 2 Scraped)</b>')
            .replace('닫기', '')
            .replace('텍스트 복사', '')
            .trim();
